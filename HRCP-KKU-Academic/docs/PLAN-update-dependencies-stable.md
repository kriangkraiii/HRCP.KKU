...
| :---: | :--- | :---: | :---: | :--- |
| 1 | `com.amazonaws:aws-java-sdk-s3` | `1.12.700` | **`1.12.797`** | ✅ Stable Full Release (อัปเดตแล้ว) |
| 2 | `org.jodconverter:jodconverter-local` | `4.4.7` | **`4.4.11`** | ✅ Stable Full Release (อัปเดตแล้ว) |
| 3 | `fr.opensagres.xdocreport:fr.opensagres.poi.xwpf.converter.pdf` | `2.1.0` | **`2.2.0`** | ✅ Stable Full Release (อัปเดตแล้ว) |
| 4 | `net.jqwik:jqwik` *(test scope)* | `1.8.2` | **`1.10.1`** | ✅ Stable Full Release (อัปเดตแล้ว) |
| 5 | `org.owasp:dependency-check-maven` *(plugin)* | `12.1.0` | **`13.0.0`** | ✅ Stable Full Release (อัปเดตแล้ว) |
| 6 | `com.deepoove:poi-tl` | `1.12.2` | **`1.12.2` (คงเดิม)** | 🔒 ตรวจพบ `1.12.3-beta1` เป็นรุ่น Beta จึงคง `1.12.2` ที่เสถียรไว้ |
| 7 | `org.passay:passay` | `2.0.0` | **`2.0.0` (คงเดิม)** | ✅ ล่าสุดและเสถียรแล้ว |
| 8 | `com.google.zxing:core` & `javase` | `3.5.4` | **`3.5.4` (คงเดิม)** | ✅ ล่าสุดและเสถียรแล้ว |
| 9 | `net.lingala.zip4j:zip4j` | `2.11.6` | **`2.11.6` (คงเดิม)** | ✅ ล่าสุดและเสถียรแล้ว |
| 10 | `org.apache.poi:poi-ooxml` & `full` | `5.5.1` | **`5.5.1` (คงเดิม)** | ✅ ล่าสุดและเสถียรแล้ว |
