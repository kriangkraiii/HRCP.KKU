...
//
//     @Test
//     @DisplayName("AdminStorage: Default (0 bytes) should be unlimited")
//     void adminStorage_defaultIsUnlimited() {
//         AdminStorageService unlimitedAdminService = new AdminStorageService(
//                 adminFolderRepo, adminFileRepo, 0L, "pdf,doc,docx,zip");
//
//         assertTrue(unlimitedAdminService.isUnlimited());
//         assertEquals(-1L, unlimitedAdminService.getRemainingBytes());
//
//         // Any size should pass without exception
//         assertDoesNotThrow(() -> unlimitedAdminService.validateStorageQuota(100L * 1024L * 1024L * 1024L));
//     }
// }
