...
function initBreadcrumbs() {
    ...
    var title = document.title ? document.title.replace(' - CP HRD', '').replace('CP HRD - ', '').replace(' - CP-HRD', '').replace('CP-HRD - ', '').replace(' - CP ACAD', '').replace('CP ACAD - ', '').replace(' - HRCP KKU', '').replace('HRCP KKU - ', '').trim() : '';
    ...
    if (!matched) {
        ...
        } else if (title && title !== 'CP HRD' && title !== 'CP-HRD' && title !== 'CP ACAD' && title !== 'CP-ACAD' && title !== 'HRCP.KKU' && title !== 'Academic') {
            matched = title;
        } else {
