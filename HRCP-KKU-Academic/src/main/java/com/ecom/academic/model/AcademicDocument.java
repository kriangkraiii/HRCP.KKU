...
@Entity
@Table(name = "academic_document", indexes = {
        @Index(name = "idx_acad_doc_req_type", columnList = "request_id, document_type"),
        @Index(name = "idx_acad_doc_req_draft", columnList = "request_id, is_draft, is_deleted")
})
