...
@Entity
@Table(name = "academic_document_edit_log", indexes = {
        @Index(name = "idx_acad_doc_log_req_date", columnList = "request_id, edited_at DESC")
})
public class AcademicDocumentEditLog {
    ...
    public AcademicRequest getRequest() { return request; }
    public void setRequest(AcademicRequest request) { this.request = request; }
